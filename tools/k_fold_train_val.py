...
def k_fold_train_val(train_dataset, train_params, sim_params):
    ...
    kfold = KFold(n_splits=train_params.k, shuffle=True)
    ...
    #     print('--------------------------------')
        ...
        train_loader = DataLoader(train_dataset, batch_size=train_params.batch_size, sampler=train_subsampler)
        valid_loader = DataLoader(train_dataset, batch_size=train_params.batch_size, sampler=valid_subsampler)
        ...
        for epoch in range(train_params.num_epochs):
            train_loss = train_epoch(model, train_params.device, train_loader, train_params.criterions, optimizer)
            valid_loss = valid_epoch(model, train_params.device, valid_loader, train_params.criterions)
